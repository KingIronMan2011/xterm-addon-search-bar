  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      ((t.IBufferService = i.createDecorator('BufferService')),
        ...
        (t.IInstantiationService = i.createDecorator('InstantiationService')),
    ...
    function (e, t, r) {
      ...
      ((t.ICharSizeService = i.createDecorator('CharSizeService')),
        (t.ICoreBrowserService = i.createDecorator('CoreBrowserService')),
          ...
          return (
            ...
            (t.prototype.setFromCharData = function (e) {
              ...
              if (e[s.CHAR_DATA_CHAR_INDEX].length > 2) t = !0;
                ...
                this.content =
                  e[s.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | (e[s.CHAR_DATA_WIDTH_INDEX] << 22);
              t &&
        ...
        (t.utf32ToString = function (e, t, r) {
          ...
          for (var i = '', n = t; n < r; ++n) {
            ...
            o > 65535
              ? ((o -= 65536),
                (i +=
                  String.fromCharCode(55296 + (o >> 10)) + String.fromCharCode((o % 1024) + 56320)))
          ...
          (e.prototype.decode = function (e, t) {
            ...
            this._interim &&
              (56320 <= (a = e.charCodeAt(n++)) && a <= 57343
                ? (t[i++] = 1024 * (this._interim - 55296) + a - 56320 + 65536)
          ...
          (e.prototype.decode = function (e, t) {
            ...
            if (this.interim[0]) {
              ...
              for (var f = 0, _ = void 0; (_ = 63 & this.interim[++f]) && f < 4; )
                ((u <<= 6), (u |= _));
              for (
                var d = 192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4,
                  p = d - f;
                l < p;
              ) {
                if (l >= r) return 0;
            ...
            for (var v = r - 4, g = l; g < r; ) {
              ...
              if ((i = e[g++]) < 128) t[a++] = i;
                ...
                if (g >= r)
                  return ((this.interim[0] = i), (this.interim[1] = n), (this.interim[2] = o), a);
                if (128 != (192 & (s = e[g++]))) {
                  g--;
                  continue;
                }
                if (
                  (c = ((7 & i) << 18) | ((63 & n) << 12) | ((63 & o) << 6) | (63 & s)) < 65536 ||
                  c > 1114111
                )
                  continue;
                t[a++] = c;
    ...
    function (e, t, r) {
      ...
      (Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        })((i = t.channels || (t.channels = {}))),
        ((n = t.color || (t.color = {})).blend = function (e, t) {
          var r = (255 & t.rgba) / 255;
          if (1 === r) return { css: t.css, rgba: t.rgba };
          var n = (t.rgba >> 24) & 255,
            o = (t.rgba >> 16) & 255,
            s = (t.rgba >> 8) & 255,
            a = (e.rgba >> 24) & 255,
          ...
          return { css: i.toCss(h, u, f), rgba: i.toRgba(h, u, f) };
        }),
        ...
        (n.opaque = function (e) {
          var t = (255 | e.rgba) >>> 0,
            ...
            o = r[1],
            a = r[2];
          return { css: i.toCss(n, o, a), rgba: t };
        }),
        ...
        (function (e) {
          function t(e, t, r) {
            for (
              var i = (e >> 24) & 255,
                ...
                l = (t >> 16) & 255,
                h = (t >> 8) & 255,
                u = c(o.relativeLuminance2(a, h, l), o.relativeLuminance2(i, n, s));
              u < r && (a > 0 || l > 0 || h > 0);
            )
          ...
          ((e.ensureContrastRatio = function (e, i, n) {
            ...
            (e.toColor = function (e, t, r) {
              return { css: i.toCss(e, t, r), rgba: i.toRgba(e, t, r) };
            }));
        })((s = t.rgba || (t.rgba = {}))),
        (t.toPaddedHex = a),
        (t.contrastRatio = c));
    ...
    function (e, t, r) {
      ...
      ((t.isFirefox = !!~n.indexOf('Firefox')),
        (t.isSafari = /^((?!chrome|android).)*safari/i.test(n)),
        (t.isMac = s(['Macintosh', 'MacIntel', 'MacPPC', 'Mac68K'], o)),
        (t.isIpad = 'iPad' === o),
        (t.isIphone = 'iPhone' === o),
        (t.isWindows = s(['Windows', 'Win16', 'Win32', 'WinCE'], o)),
        ...
        l = (function () {
          ...
          return (
            ...
            (e.prototype._initCanvas = function () {
              ((this._ctx = a.throwIfFalsy(this._canvas.getContext('2d', { alpha: this._alpha }))),
            ...
            (e.prototype._fillBottomLineAtCells = function (e, t, r) {
              (void 0 === r && (r = 1),
                this._ctx.fillRect(
                  e * this._scaledCellWidth,
                  (t + 1) * this._scaledCellHeight - window.devicePixelRatio - 1,
                  r * this._scaledCellWidth,
            ...
            (e.prototype._fillCharTrueColor = function (e, t, r) {
              ((this._ctx.font = this._getFont(!1, !1)),
                ...
                this._ctx.fillText(
                  ...
                  r * this._scaledCellHeight + this._scaledCharTop + this._scaledCharHeight / 2,
                ));
            }),
            (e.prototype._drawChars = function (e, t, r) {
              ...
              a || e.isFgRGB() || e.isBgRGB()
                ...
                : (e.isInverse()
                    ? ((o = e.isBgDefault() ? n.INVERTED_DEFAULT_COLOR : e.getBgColor()),
                      (s = e.isFgDefault() ? n.INVERTED_DEFAULT_COLOR : e.getFgColor()))
                    : ((s = e.isBgDefault() ? i.DEFAULT_COLOR : e.getBgColor()),
                      (o = e.isFgDefault() ? i.DEFAULT_COLOR : e.getFgColor())),
                  (o +=
                    this._optionsService.options.drawBoldTextInBrightColors && e.isBold() && o < 8
                      ? 8
                      : 0),
                  (this._currentGlyphIdentifier.chars = e.getChars() || i.WHITESPACE_CELL_CHAR),
                  (this._currentGlyphIdentifier.code = e.getCode() || i.WHITESPACE_CELL_CODE),
            ...
            (e.prototype._drawUncachedChars = function (e, t, r, i) {
              if (
                ...
                if (i) this._ctx.fillStyle = i.css;
                  ...
                  this._ctx.fillStyle =
                    'rgb(' + s.AttributeData.toColorRGB(e.getBgColor()).join(',') + ')';
                else {
                  var o = e.getBgColor();
                  (this._optionsService.options.drawBoldTextInBrightColors &&
                    e.isBold() &&
                    o < 8 &&
                    (o += 8),
                ...
                this._ctx.fillStyle =
                  'rgb(' + s.AttributeData.toColorRGB(e.getFgColor()).join(',') + ')';
              else {
                var a = e.getFgColor();
                (this._optionsService.options.drawBoldTextInBrightColors &&
                  e.isBold() &&
            ...
            (e.prototype._getFont = function (e, t) {
              return (
                ...
                ' ' +
                this._optionsService.options.fontSize * window.devicePixelRatio +
                'px ' +
    ...
    function (e, t, r) {
      ...
      var i = 'di$target',
        n = 'di$dependencies';
      function o(e, t, r) {
        t[i] === t ? t[n].push({ id: e, index: r }) : ((t[n] = [{ id: e, index: r }]), (t[i] = t));
      }
      ...
      var c = (function () {
        function e(e, t, r) {
          (void 0 === r && (r = !1),
            (this.isWrapped = r),
            (this._combined = {}),
            (this._data = new Uint32Array(e * a)));
          for (
            var i =
                t ||
                o.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]),
              s = 0;
            s < e;
            ++s
          )
        ...
        return (
          (e.prototype.get = function (e) {
            ...
            return [
              this._data[e * a + 1],
              2097152 & t ? this._combined[e] : r ? i.stringFromCodePoint(r) : '',
              t >> 22,
              2097152 & t ? this._combined[e].charCodeAt(this._combined[e].length - 1) : r,
            ];
          }),
          (e.prototype.set = function (e, t) {
            ((this._data[e * a + 1] = t[n.CHAR_DATA_ATTR_INDEX]),
              t[n.CHAR_DATA_CHAR_INDEX].length > 1
                ? ((this._combined[e] = t[1]),
                  (this._data[e * a + 0] = 2097152 | e | (t[n.CHAR_DATA_WIDTH_INDEX] << 22)))
                : (this._data[e * a + 0] =
                    t[n.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | (t[n.CHAR_DATA_WIDTH_INDEX] << 22)));
          }),
          ...
          (e.prototype.setCell = function (e, t) {
            (2097152 & t.content && (this._combined[e] = t.combinedData),
              (this._data[e * a + 0] = t.content),
              (this._data[e * a + 1] = t.fg),
              (this._data[e * a + 2] = t.bg));
          }),
          (e.prototype.setCellFromCodePoint = function (e, t, r, i, n) {
            ((this._data[e * a + 0] = t | (r << 22)),
              (this._data[e * a + 1] = i),
              (this._data[e * a + 2] = n));
          }),
          (e.prototype.addCodepointToCell = function (e, t) {
            ...
            2097152 & r
              ...
              : (2097151 & r
                  ? ((this._combined[e] =
                      i.stringFromCodePoint(2097151 & r) + i.stringFromCodePoint(t)),
                    (r &= -2097152),
                    (r |= 2097152))
                  : (r = t | (1 << 22)),
                (this._data[e * a + 0] = r));
            ...
            if (
              ((e %= this.length) &&
                ...
                this.setCellFromCodePoint(
                  ...
                  0,
                  1,
                  (null === (n = i) || void 0 === n ? void 0 : n.fg) || 0,
                  (null === (s = i) || void 0 === s ? void 0 : s.bg) || 0,
                ),
              t < this.length - e)
            ) {
              for (var l = new o.CellData(), h = this.length - e - t - 1; h >= 0; --h)
                this.setCell(e + t + h, this.loadCell(e + h, l));
              for (h = 0; h < t; ++h) this.setCell(e + h, r);
            } else for (h = e; h < this.length; ++h) this.setCell(h, r);
            2 === this.getWidth(this.length - 1) &&
              this.setCellFromCodePoint(
                this.length - 1,
                0,
                1,
                (null === (a = i) || void 0 === a ? void 0 : a.fg) || 0,
                (null === (c = i) || void 0 === c ? void 0 : c.bg) || 0,
              );
          }),
          (e.prototype.deleteCells = function (e, t, r, i) {
            var n, s, a, c;
            if (((e %= this.length), t < this.length - e)) {
              for (var l = new o.CellData(), h = 0; h < this.length - e - t; ++h)
                this.setCell(e + h, this.loadCell(e + t + h, l));
            ...
            for (
              e &&
                ...
                this.setCellFromCodePoint(
                  ...
                  1,
                  (null === (n = i) || void 0 === n ? void 0 : n.fg) || 0,
                  (null === (o = i) || void 0 === o ? void 0 : o.bg) || 0,
                ),
                t < this.length &&
                  2 === this.getWidth(t - 1) &&
                  this.setCellFromCodePoint(
                    ...
                    0,
                    1,
                    (null === (s = i) || void 0 === s ? void 0 : s.fg) || 0,
                    (null === (a = i) || void 0 === a ? void 0 : a.bg) || 0,
                  );
              e < t && e < this.length;
            )
              this.setCell(e++, r);
          ...
          (e.prototype.resize = function (e, t) {
            if (e !== this.length) {
              if (e > this.length) {
                ...
                (this.length &&
                  (e * a < this._data.length
                    ? r.set(this._data.subarray(0, e * a))
                    : r.set(this._data)),
                  (this._data = r));
          ...
          return (
            (e.fromArray = function (t) {
              ...
              for (var i = t[0] instanceof Array ? 1 : 0; i < t.length; ++i) {
                var n = t[i];
                if (n instanceof Array) for (var o = 0; o < n.length; ++o) r.addSubParam(n[o]);
                else r.addParam(n);
              }
              return r;
            }),
            ...
            (e.prototype.addParam = function (e) {
              if (((this._digitIsSub = !1), this.length >= this.maxLength)) this._rejectDigits = !0;
                ...
                ((this._subParamsIdx[this.length] =
                  ...
                  (this.params[this.length++] = e > 2147483647 ? 2147483647 : e));
              }
            }),
            (e.prototype.addSubParam = function (e) {
              if (((this._digitIsSub = !0), this.length))
                if (this._rejectDigits || this._subParamsLength >= this.maxSubParamsLength)
                  ...
                  if (e < -1) throw new Error('values lesser than -1 are not allowed');
                  ((this._subParams[this._subParamsLength++] = e > 2147483647 ? 2147483647 : e),
        ...
        o = (function () {
          ...
          return (
            ...
            (e.prototype._start = function () {
              ...
              if (e) for (var t = e.length - 1; t >= 0; t--) e[t].start();
              else this._handlerFb(this._id, 'START');
            }),
            (e.prototype._put = function (e, t, r) {
              var i = this._handlers[this._id];
              if (i) for (var o = i.length - 1; o >= 0; o--) i[o].put(e, t, r);
            ...
            (e.prototype.end = function (e) {
              0 !== this._state &&
                (3 !== this._state && (1 === this._state && this._start(), this._end(e)),
                (this._id = -1),
                (this._state = 0));
            }),
            e
        ...
        return (
          ...
          (e.prototype.put = function (e, t, r) {
            this._hitLimit ||
              ...
              this._data.length > i.PAYLOAD_LIMIT && ((this._data = ''), (this._hitLimit = !0)));
          }),
          (e.prototype.end = function (e) {
            var t;
            return (
              this._hitLimit ? (t = !1) : e && (t = this._handler(this._data)),
              (this._data = ''),
              (this._hitLimit = !1),
              t
            );
    ...
    function (e, t, r) {
      'use strict';
      (Object.defineProperty(t, '__esModule', { value: !0 }), (t.PAYLOAD_LIMIT = 1e7));
    },
    function (e, t, r) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 });
        ...
        return (
          ...
          (e.prototype.put = function (e, t, r) {
            this._hitLimit ||
              ...
              this._data.length > o.PAYLOAD_LIMIT && ((this._data = ''), (this._hitLimit = !0)));
          }),
          (e.prototype.unhook = function (e) {
            var t;
            return (
              this._hitLimit
                ? (t = !1)
                : e &&
                  (t = this._handler(this._data, this._params ? this._params : new n.Params())),
              (this._params = void 0),
              (this._data = ''),
              (this._hitLimit = !1),
              t
      ...
      var h = (function () {
        ...
        return (
          ...
          (e.prototype.setTheme = function (e) {
            (void 0 === e && (e = {}),
              (this.colors.foreground = this._parseColor(e.foreground, o)),
              (this.colors.background = this._parseColor(e.background, s)),
              (this.colors.cursor = this._parseColor(e.cursor, a, !0)),
              (this.colors.cursorAccent = this._parseColor(e.cursorAccent, c, !0)),
          ...
          (e.prototype._parseColor = function (e, t, r) {
            ...
            if (
              ...
              return (console.warn('Color: ' + e + ' is invalid using fallback ' + t.css), t);
            ...
            if (255 !== n[3]) {
              ...
              var o = this._ctx.fillStyle
                ...
                l = o[3],
                h = Math.round(255 * l);
              return { rgba: i.channels.toRgba(s, a, c, h), css: i.channels.toCss(s, a, c, h) };
            }
      ...
      var l = (function () {
        ...
        return (
            ...
            for (
              ...
              if ((t.loadCell(h, this._workCell), 0 !== this._workCell.getWidth())) {
                if (this._workCell.fg !== c || this._workCell.bg !== l) {
                  if (h - n > 1)
                    for (var u = this._getJoinedRanges(i, a, o, t, n), f = 0; f < u.length; f++)
                      r.push(u[f]);
          ...
          (e.prototype._getJoinedRanges = function (t, r, i, n, o) {
            for (
              var s = t.substring(r, i), a = this._characterJoiners[0].handler(s), c = 1;
    ...
    function (e, t, r) {
      ...
      (Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.getCoords = function (e, t, r, n, o, s, a, c) {
          if (o) {
            var l = i(e, t);
            if (l)
              return (
          ...
          (t.prototype.setListener = function (e) {
            ...
            (this._listener && this.clearListener(),
              ...
              (this._outerListener = function () {
                t._listener &&
                  (t._listener(window.devicePixelRatio, t._currentDevicePixelRatio),
                  t._updateDpr());
              }),
              this._updateDpr());
          }),
        ...
        N = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (r._onBinary = new S.EventEmitter()),
              ...
              (r._instantiationService = new I.InstantiationService()),
              (r.optionsService = new R.OptionsService(t)),
              r._instantiationService.setService(A.IOptionsService, r.optionsService),
              (r._bufferService = r._instantiationService.createInstance(D.BufferService)),
              r._instantiationService.setService(A.IBufferService, r._bufferService),
              (r._logService = r._instantiationService.createInstance(P.LogService)),
              ...
              r._instantiationService.setService(A.ICoreService, r._coreService),
              r._coreService.onData(function (e) {
                return r._onData.fire(e);
              }),
              r._coreService.onBinary(function (e) {
                return r._onBinary.fire(e);
              }),
              (r._coreMouseService = r._instantiationService.createInstance(B.CoreMouseService)),
              r._instantiationService.setService(A.ICoreMouseService, r._coreMouseService),
              (r._dirtyRowService = r._instantiationService.createInstance(H.DirtyRowService)),
              r._instantiationService.setService(A.IDirtyRowService, r._dirtyRowService),
              (r.unicodeService = r._instantiationService.createInstance(W.UnicodeService)),
              r._instantiationService.setService(A.IUnicodeService, r.unicodeService),
              (r._charsetService = r._instantiationService.createInstance(q.CharsetService)),
              r._instantiationService.setService(A.ICharsetService, r._charsetService),
              r._setupOptionsListeners(),
              r._setup(),
              (r._writeBuffer = new F.WriteBuffer(function (e) {
          ...
          return (
            ...
            (t.prototype.dispose = function () {
              ...
              this._isDisposed ||
                ...
                null === (r = this._renderService) || void 0 === r || r.dispose(),
                (this._customKeyEventHandler = null),
                (this.write = function () {}),
                null ===
                  (n = null === (i = this.element) || void 0 === i ? void 0 : i.parentNode) ||
                  void 0 === n ||
            ...
            (t.prototype._setup = function () {
              ...
              ((this._customKeyEventHandler = null),
                ...
                this._inputHandler
                  ...
                  : ((this._inputHandler = new l.InputHandler(
                      this,
                      this._bufferService,
                ...
                this.linkifier ||
                  (this.linkifier = new u.Linkifier(
                    this._bufferService,
                    this._logService,
                    this.optionsService,
                    this.unicodeService,
                  )),
                this.options.windowsMode && this._enableWindowsMode());
            }),
            (t.prototype._enableWindowsMode = function () {
              ...
              if (!this._windowsMode) {
                var t = [];
                (t.push(
                  this.onLineFeed(w.updateWindowsModeWrappedState.bind(null, this._bufferService)),
                ),
                  t.push(
            ...
            (t.prototype._setupOptionsListeners = function () {
              ...
              this.optionsService.onOptionChange(function (t) {
                ...
                switch (t) {
                  case 'fontFamily':
                  case 'fontSize':
                    (null === (r = e._renderService) || void 0 === r || r.clear(),
                      null === (i = e._charSizeService) || void 0 === i || i.measure());
                    break;
                  case 'cursorBlink':
                  case 'cursorStyle':
                  ...
                  case 'minimumContrastRatio':
                    e._renderService &&
                      (e._renderService.clear(),
                      e._renderService.onResize(e.cols, e.rows),
                      e.refresh(0, e.rows - 1));
                    break;
                  case 'rendererType':
                    e._renderService &&
                      (e._renderService.setRenderer(e._createRenderer()),
                      e._renderService.onResize(e.cols, e.rows));
                    break;
                  case 'scrollback':
                    (e.buffers.resize(e.cols, e.rows),
                      null === (n = e.viewport) || void 0 === n || n.syncScrollArea());
                    break;
                  case 'screenReaderMode':
                    e.optionsService.options.screenReaderMode
                      ? !e._accessibilityManager &&
                        e._renderService &&
                        (e._accessibilityManager = new y.AccessibilityManager(e, e._renderService))
                      : (null === (o = e._accessibilityManager) || void 0 === o || o.dispose(),
                        (e._accessibilityManager = null));
                    break;
                  case 'tabStopWidth':
                  ...
                  case 'theme':
                    ...
                    break;
                  case 'windowsMode':
                    e.optionsService.options.windowsMode
                      ? e._enableWindowsMode()
                      : (null === (s = e._windowsMode) || void 0 === s || s.dispose(),
                        (e._windowsMode = void 0));
                }
              });
            }),
            (t.prototype._onTextAreaFocus = function (e) {
              (this.sendFocus && this._coreService.triggerDataEvent(c.C0.ESC + '[I'),
            ...
            (t.prototype._onTextAreaBlur = function () {
              ((this.textarea.value = ''),
                ...
                this.sendFocus && this._coreService.triggerDataEvent(c.C0.ESC + '[O'),
            ...
            (t.prototype._initGlobal = function () {
              ...
              (this._bindKeys(),
                this.register(
                  d.addDisposableDomListener(this.element, 'copy', function (t) {
              ...
              (this.register(d.addDisposableDomListener(this.textarea, 'paste', t)),
                this.register(d.addDisposableDomListener(this.element, 'paste', t)),
                _.isFirefox
                  ? this.register(
                      d.addDisposableDomListener(this.element, 'mousedown', function (t) {
                        2 === t.button &&
                          a.rightClickHandler(
                            t,
                            e.textarea,
                  ...
                  : this.register(
                      d.addDisposableDomListener(this.element, 'contextmenu', function (t) {
                        a.rightClickHandler(
                          t,
                          e.textarea,
                          e.screenElement,
                ...
                _.isLinux &&
                  this.register(
                    d.addDisposableDomListener(this.element, 'auxclick', function (t) {
                      1 === t.button &&
                        a.moveTextAreaUnderMouseCursor(t, e.textarea, e.screenElement);
                    }),
                  ));
            }),
            (t.prototype._bindKeys = function () {
              ...
              (this.register(
                ...
                this.register(
                  d.addDisposableDomListener(this.textarea, 'compositionstart', function () {
                    return e._compositionHelper.compositionstart();
                  }),
                ),
                this.register(
                  d.addDisposableDomListener(this.textarea, 'compositionupdate', function (t) {
                    return e._compositionHelper.compositionupdate(t);
                  }),
                ),
                this.register(
                  d.addDisposableDomListener(this.textarea, 'compositionend', function () {
            ...
            (t.prototype.open = function (e) {
              ...
              ((this._viewportElement = U.createElement('div')),
                ...
                this.register(
                  d.addDisposableDomListener(this.textarea, 'focus', function (e) {
                    return t._onTextAreaFocus(e);
                  }),
                ),
                this.register(
                  d.addDisposableDomListener(this.textarea, 'blur', function () {
              ...
              (this._instantiationService.setService(x.ICoreBrowserService, i),
                (this._charSizeService = this._instantiationService.createInstance(
                  k.CharSizeService,
                  this._document,
                  this._helperContainer,
                )),
                this._instantiationService.setService(x.ICharSizeService, this._charSizeService),
                ...
                (this._colorManager = new E.ColorManager(U, this.options.allowTransparency)),
                this.optionsService.onOptionChange(function (e) {
                  return t._colorManager.onOptionsChange(e);
                }),
                this._colorManager.setTheme(this._theme));
              var n = this._createRenderer();
              ((this._renderService = this._instantiationService.createInstance(
                L.RenderService,
                n,
                this.rows,
                this.screenElement,
              )),
                this._instantiationService.setService(x.IRenderService, this._renderService),
                this._renderService.onRender(function (e) {
                  return t._onRender.fire(e);
                }),
                this.onResize(function (e) {
                  return t._renderService.resize(e.cols, e.rows);
                }),
                (this._soundService = this._instantiationService.createInstance(v.SoundService)),
                this._instantiationService.setService(x.ISoundService, this._soundService),
                (this._mouseService = this._instantiationService.createInstance(O.MouseService)),
                this._instantiationService.setService(x.IMouseService, this._mouseService),
                ...
                (this._selectionService = this._instantiationService.createInstance(
                  f.SelectionService,
                  function (e, r) {
                    return t.scrollLines(e, r);
                  },
                ...
                this._instantiationService.setService(x.ISelectionService, this._selectionService),
                this.register(
                ...
                this.register(
                  this._selectionService.onRedrawRequest(function (e) {
                ...
                this.register(
                  d.addDisposableDomListener(this._viewportElement, 'scroll', function () {
                ...
                this.register(
                  d.addDisposableDomListener(this.element, 'mousedown', function (e) {
            ...
            (t.prototype.bindMouse = function () {
              ...
              function i(e) {
                var r, i, n;
                if (!(r = t._mouseService.getRawByteCoords(e, t.screenElement, t.cols, t.rows)))
                  return !1;
                switch (e.overrideType || e.type) {
                  case 'mousemove':
                    ((n = 32),
                      void 0 === e.buttons
                        ? ((i = 3), void 0 !== e.button && (i = e.button < 3 ? e.button : 3))
                        : (i = 1 & e.buttons ? 0 : 4 & e.buttons ? 1 : 2 & e.buttons ? 2 : 3));
                    break;
                  case 'mouseup':
              ...
              var n = { mouseup: null, wheel: null, mousedrag: null, mousemove: null },
                o = function (t) {
                  return (
                    i(t),
                    t.buttons ||
              ...
              (this._coreMouseService.onProtocolChange(function (t) {
                ((e.mouseEvents = t),
                  t
                    ? ('debug' === e.optionsService.options.logLevel &&
                        e._logService.debug(
                  ...
                  8 & t
                    ? n.mousemove || (r.addEventListener('mousemove', l), (n.mousemove = l))
                    : (r.removeEventListener('mousemove', n.mousemove), (n.mousemove = null)),
                  16 & t
                    ? n.wheel || (r.addEventListener('wheel', s), (n.wheel = s))
                    : (r.removeEventListener('wheel', n.wheel), (n.wheel = null)),
                  2 & t
                    ? n.mouseup || (n.mouseup = o)
                    : (e._document.removeEventListener('mouseup', n.mouseup), (n.mouseup = null)),
                  4 & t
                    ? n.mousedrag || (n.mousedrag = a)
                    : (e._document.removeEventListener('mousemove', n.mousedrag),
                      (n.mousedrag = null)));
              }),
                (this._coreMouseService.activeProtocol = this._coreMouseService.activeProtocol),
                this.register(
                  d.addDisposableDomListener(r, 'mousedown', function (t) {
                    if (
                      (t.preventDefault(),
                      e.focus(),
                      e.mouseEvents && !e._selectionService.shouldForceSelection(t))
                    )
                      return (
                        i(t),
                ...
                this.register(
                  d.addDisposableDomListener(r, 'wheel', function (t) {
                    if (n.wheel);
                      ...
                      for (
                        var i =
                            c.C0.ESC +
                            (e._coreService.decPrivateModes.applicationCursorKeys ? 'O' : '[') +
                            (t.deltaY < 0 ? 'A' : 'B'),
                          o = '',
                          s = 0;
                        s < Math.abs(r);
                ...
                this.register(
                  d.addDisposableDomListener(r, 'touchstart', function (t) {
                    if (!e.mouseEvents) return (e.viewport.onTouchStart(t), e.cancel(t));
                  }),
                ),
                this.register(
                  d.addDisposableDomListener(r, 'touchmove', function (t) {
            ...
            (t.prototype.updateCursorStyle = function (e) {
              this._selectionService && this._selectionService.shouldColumnSelect(e)
            ...
            (t.prototype.scroll = function (e, t) {
              ...
              (void 0 === t && (t = !1),
                ((r = this._blankLine) &&
                  ...
                  r.getFg(0) === e.fg &&
                  r.getBg(0) === e.bg) ||
                  ((r = this.buffer.getBlankLine(e, t)), (this._blankLine = r)),
                (r.isWrapped = t));
              ...
              if (0 === this.buffer.scrollTop) {
                ...
                (n === this.buffer.lines.length - 1
                  ? o
                    ? this.buffer.lines.recycle().copyFrom(r)
                    : this.buffer.lines.push(r.clone())
                  : this.buffer.lines.splice(n + 1, 0, r.clone()),
                  o
                    ? this._userScrolling &&
                      (this.buffer.ydisp = Math.max(this.buffer.ydisp - 1, 0))
                    : (this.buffer.ybase++, this._userScrolling || this.buffer.ydisp++));
              } else {
                var s = n - i + 1;
                (this.buffer.lines.shiftElements(i + 1, s - 1, -1),
                  this.buffer.lines.set(n, r.clone()));
              }
              (this._userScrolling || (this.buffer.ydisp = this.buffer.ybase),
                this._dirtyRowService.markRangeDirty(
                  this.buffer.scrollTop,
                  this.buffer.scrollBottom,
                ),
            ...
            (t.prototype.scrollLines = function (e, t) {
              ...
              ((this.buffer.ydisp = Math.max(
                ...
                r !== this.buffer.ydisp &&
                  (t || this._onScroll.fire(this.buffer.ydisp), this.refresh(0, this.rows - 1)));
            }),
            ...
            (t.prototype._keyDown = function (e) {
              ...
              if (!this._compositionHelper.keydown(e))
                return (this.buffer.ybase !== this.buffer.ydisp && this.scrollToBottom(), !1);
              var t = m.evaluateKeyboardEvent(
                e,
              ...
              return (
                ...
                !!this._isThirdLevelShift(this.browser, e) ||
                  ...
                  !t.key ||
                    ((t.key !== c.C0.ETX && t.key !== c.C0.CR) || (this.textarea.value = ''),
            ...
            (t.prototype.resize = function (e, t) {
              ...
              isNaN(e) ||
                ...
                (e !== this.cols || t !== this.rows
                  ? (e < D.MINIMUM_COLS && (e = D.MINIMUM_COLS),
                    t < D.MINIMUM_ROWS && (t = D.MINIMUM_ROWS),
            ...
            (t.prototype.reset = function () {
              ...
              (this._setup(),
                ...
                (this._userScrolling = i),
                this.refresh(0, this.rows - 1),
                null === (t = this.viewport) || void 0 === t || t.syncScrollArea());
            }),
            ...
            (e.prototype.updateCompositionElements = function (e) {
              ...
              if (this._isComposing) {
                if (this._bufferService.buffer.isCursorInViewport) {
                  var r = Math.ceil(
                      this._charSizeService.height * this._optionsService.options.lineHeight,
                    ),
        ...
        f = (function (e) {
          function t(t, r, i, n, o, s, a) {
            ...
            return (
              ...
              (l.scrollBarWidth = l._viewportElement.offsetWidth - l._scrollArea.offsetWidth || u),
              l.register(
                c.addDisposableDomListener(l._viewportElement, 'scroll', l._onScroll.bind(l)),
              ),
              setTimeout(function () {
          ...
          return (
            ...
            (t.prototype._innerRefresh = function () {
              if (this._charSizeService.height > 0) {
                ((this._currentRowHeight =
                  this._renderService.dimensions.scaledCellHeight / window.devicePixelRatio),
                  (this._lastRecordedViewportHeight = this._viewportElement.offsetHeight));
                var e =
                  Math.round(this._currentRowHeight * this._lastRecordedBufferLength) +
                  (this._lastRecordedViewportHeight - this._renderService.dimensions.canvasHeight);
              ...
              (this._viewportElement.scrollTop !== t &&
                ((this._ignoreNextScrollEvent = !0), (this._viewportElement.scrollTop = t)),
            ...
            (t.prototype._applyScrollModifier = function (e, t) {
              ...
              return ('alt' === r && t.altKey) ||
                ...
                ('shift' === r && t.shiftKey)
                ? e *
                    this._optionsService.options.fastScrollSensitivity *
    ...
    function (e, t, r) {
      ...
      (Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.handlePasteEvent = function (e, t, r, i) {
          (e.stopPropagation(),
            e.clipboardData && o(e.clipboardData.getData('text/plain'), t, r, i));
        }),
        (t.paste = o),
        (t.moveTextAreaUnderMouseCursor = s),
        (t.rightClickHandler = function (e, t, r, i, n) {
          (s(e, t, r),
            n && !i.isClickInSelection(e) && i.selectWordAtCursor(e),
              ...
              if (e) {
                ...
                switch (((this._data = new Uint32Array(0)), t)) {
                  ...
                  case ' q':
                    ...
                    return (
                      (i -= this._optionsService.options.cursorBlink ? 1 : 0),
                  ...
                  default:
                    (this._logService.debug('Unknown DCS $q %s', t),
                      this._coreService.triggerDataEvent(o.C0.ESC + 'P0$r' + o.C0.ESC + '\\'));
                }
        ...
        C = (function (e) {
          function t(t, r, i, n, c, l, _, p, g, y, b) {
            ...
            ((m._terminal = t),
              ...
              (m._charsetService = i),
              (m._coreService = n),
              (m._dirtyRowService = c),
              (m._logService = l),
              (m._optionsService = _),
              (m._coreMouseService = p),
              (m._unicodeService = g),
              (m._instantiationService = y),
              (m._parser = b),
              (m._parseBuffer = new Uint32Array(4096)),
              (m._stringDecoder = new h.StringToUtf32()),
              (m._utf8Decoder = new h.Utf8ToUtf32()),
              (m._workCell = new d.CellData()),
              (m._windowTitle = ''),
              (m._iconName = ''),
              (m._windowTitleStack = []),
              (m._iconNameStack = []),
              (m._curAttrData = u.DEFAULT_ATTR_DATA.clone()),
              (m._eraseAttrDataInternal = u.DEFAULT_ATTR_DATA.clone()),
              (m._onRequestRefreshRows = new f.EventEmitter()),
              (m._onRequestReset = new f.EventEmitter()),
              (m._onRequestBell = new f.EventEmitter()),
              (m._onCursorMove = new f.EventEmitter()),
              (m._onLineFeed = new f.EventEmitter()),
              (m._onScroll = new f.EventEmitter()),
              m.register(m._parser),
              m._parser.setCsiHandlerFallback(function (e, t) {
              ...
              m._parser.setExecuteHandlerFallback(function (e) {
                m._logService.debug('Unknown EXECUTE code: ', { code: e });
              }),
              m._parser.setOscHandlerFallback(function (e, t, r) {
                m._logService.debug('Unknown OSC code: ', { identifier: e, action: t, data: r });
              }),
              m._parser.setDcsHandlerFallback(function (e, t, r) {
                ('HOOK' === t && (r = r.toArray()),
                  m._logService.debug('Unknown DCS code: ', {
                    identifier: m._parser.identToString(e),
                    action: t,
                    payload: r,
                  }));
              ...
              m._parser.setCsiHandler({ final: '@' }, function (e) {
                return m.insertChars(e);
              }),
              m._parser.setCsiHandler({ intermediates: ' ', final: '@' }, function (e) {
                return m.scrollLeft(e);
              }),
              m._parser.setCsiHandler({ final: 'A' }, function (e) {
                return m.cursorUp(e);
              }),
              m._parser.setCsiHandler({ intermediates: ' ', final: 'A' }, function (e) {
                return m.scrollRight(e);
              }),
              m._parser.setCsiHandler({ final: 'B' }, function (e) {
                return m.cursorDown(e);
              }),
              m._parser.setCsiHandler({ final: 'C' }, function (e) {
                return m.cursorForward(e);
              }),
              m._parser.setCsiHandler({ final: 'D' }, function (e) {
                return m.cursorBackward(e);
              }),
              m._parser.setCsiHandler({ final: 'E' }, function (e) {
                return m.cursorNextLine(e);
              }),
              m._parser.setCsiHandler({ final: 'F' }, function (e) {
                return m.cursorPrecedingLine(e);
              }),
              m._parser.setCsiHandler({ final: 'G' }, function (e) {
                return m.cursorCharAbsolute(e);
              }),
              m._parser.setCsiHandler({ final: 'H' }, function (e) {
                return m.cursorPosition(e);
              }),
              m._parser.setCsiHandler({ final: 'I' }, function (e) {
                return m.cursorForwardTab(e);
              }),
              m._parser.setCsiHandler({ final: 'J' }, function (e) {
                return m.eraseInDisplay(e);
              }),
              m._parser.setCsiHandler({ prefix: '?', final: 'J' }, function (e) {
                return m.eraseInDisplay(e);
              }),
              m._parser.setCsiHandler({ final: 'K' }, function (e) {
                return m.eraseInLine(e);
              }),
              m._parser.setCsiHandler({ prefix: '?', final: 'K' }, function (e) {
                return m.eraseInLine(e);
              }),
              m._parser.setCsiHandler({ final: 'L' }, function (e) {
                return m.insertLines(e);
              }),
              m._parser.setCsiHandler({ final: 'M' }, function (e) {
                return m.deleteLines(e);
              }),
              m._parser.setCsiHandler({ final: 'P' }, function (e) {
                return m.deleteChars(e);
              }),
              m._parser.setCsiHandler({ final: 'S' }, function (e) {
                return m.scrollUp(e);
              }),
              m._parser.setCsiHandler({ final: 'T' }, function (e) {
                return m.scrollDown(e);
              }),
              m._parser.setCsiHandler({ final: 'X' }, function (e) {
                return m.eraseChars(e);
              }),
              m._parser.setCsiHandler({ final: 'Z' }, function (e) {
              ...
              m._parser.setCsiHandler({ prefix: '>', final: 'c' }, function (e) {
              ...
              m._parser.setCsiHandler({ prefix: '?', final: 'h' }, function (e) {
                return m.setModePrivate(e);
              }),
              m._parser.setCsiHandler({ final: 'l' }, function (e) {
                return m.resetMode(e);
              }),
              m._parser.setCsiHandler({ prefix: '?', final: 'l' }, function (e) {
                return m.resetModePrivate(e);
              }),
              m._parser.setCsiHandler({ final: 'm' }, function (e) {
                return m.charAttributes(e);
              }),
              m._parser.setCsiHandler({ final: 'n' }, function (e) {
                return m.deviceStatus(e);
              }),
              m._parser.setCsiHandler({ prefix: '?', final: 'n' }, function (e) {
                return m.deviceStatusPrivate(e);
              }),
              m._parser.setCsiHandler({ intermediates: '!', final: 'p' }, function (e) {
                return m.softReset(e);
              }),
              m._parser.setCsiHandler({ intermediates: ' ', final: 'q' }, function (e) {
                return m.setCursorStyle(e);
              }),
              m._parser.setCsiHandler({ final: 'r' }, function (e) {
              ...
              m._parser.setCsiHandler({ final: 'u' }, function (e) {
              ...
              m._parser.setOscHandler(
                0,
                new v.OscHandler(function (e) {
              ...
              m._parser.setEscHandler({ final: '7' }, function () {
                return m.saveCursor();
              }),
              m._parser.setEscHandler({ final: '8' }, function () {
                return m.restoreCursor();
              }),
              m._parser.setEscHandler({ final: 'D' }, function () {
                return m.index();
              }),
              m._parser.setEscHandler({ final: 'E' }, function () {
                return m.nextLine();
              }),
              m._parser.setEscHandler({ final: 'H' }, function () {
                return m.tabSet();
              }),
              m._parser.setEscHandler({ final: 'M' }, function () {
                return m.reverseIndex();
              }),
              m._parser.setEscHandler({ final: '=' }, function () {
                return m.keypadApplicationMode();
              }),
              m._parser.setEscHandler({ final: '>' }, function () {
                return m.keypadNumericMode();
              }),
              m._parser.setEscHandler({ final: 'c' }, function () {
                return m.fullReset();
              }),
              m._parser.setEscHandler({ final: 'n' }, function () {
                return m.setgLevel(2);
              }),
              m._parser.setEscHandler({ final: 'o' }, function () {
              ...
              m._parser.setEscHandler({ intermediates: '%', final: '@' }, function () {
                return m.selectDefaultCharset();
              }),
              m._parser.setEscHandler({ intermediates: '%', final: 'G' }, function () {
                return m.selectDefaultCharset();
              }));
            var C = function (e) {
                (w._parser.setEscHandler({ intermediates: '(', final: e }, function () {
              ...
              w = this;
            for (var E in s.CHARSETS) C(E);
            return (
              m._parser.setEscHandler({ intermediates: '#', final: '8' }, function () {
              ...
              m._parser.setDcsHandler(
                ...
                new S(m._bufferService, m._coreService, m._logService, m._optionsService),
              ),
              m
            );
          }
          return (
            ...
            (t.prototype.parse = function (e) {
              ...
              if (
                ...
                this._parseBuffer.length < e.length &&
                  this._parseBuffer.length < 131072 &&
                  (this._parseBuffer = new Uint32Array(Math.min(e.length, 131072))),
                ...
                for (var n = 0; n < e.length; n += 131072) {
                  var o = n + 131072 < e.length ? n + 131072 : e.length,
                    s =
                      'string' == typeof e
                        ? this._stringDecoder.decode(e.substring(n, o), this._parseBuffer)
            ...
            (t.prototype.print = function (e, t, r) {
              ...
              (this._dirtyRowService.markDirty(o.y),
                o.x &&
                  r - t > 0 &&
                  2 === d.getWidth(o.x - 1) &&
                  d.setCellFromCodePoint(o.x - 1, 0, 1, f.fg, f.bg));
              for (var p = t; p < r; ++p) {
                ...
                if (
                  (a && this._terminal.onA11yCharEmitter.fire(h.stringFromCodePoint(i)), n || !o.x)
                ) {
                  if (o.x + n - 1 >= c)
                    if (l)
                      ((o.x = 0),
                        ...
                        o.y === o.scrollBottom + 1
                          ? (o.y--, this._terminal.scroll(this._eraseAttrData(), !0))
                  ...
                  if (
                    (u &&
                      (d.insertCells(o.x, n, o.getNullCell(f), f),
                      2 === d.getWidth(c - 1) &&
                    ...
                    d.setCellFromCodePoint(o.x++, i, n, f.fg, f.bg),
                    n > 0)
                  )
                    for (; --n; ) d.setCellFromCodePoint(o.x++, 0, 0, f.fg, f.bg);
                } else
                  d.getWidth(o.x - 1)
                    ? d.addCodepointToCell(o.x - 1, i)
                    : d.addCodepointToCell(o.x - 2, i);
              }
              (r - t > 0 &&
                (d.loadCell(o.x - 1, this._workCell),
                ...
                o.x < c &&
                  ...
                  0 === d.getWidth(o.x) &&
                  !d.hasContent(o.x) &&
                  d.setCellFromCodePoint(o.x, 0, 1, f.fg, f.bg),
                this._dirtyRowService.markDirty(o.y));
            }),
            (t.prototype.addCsiHandler = function (e, t) {
              var r = this;
            ...
            (t.prototype.lineFeed = function () {
              ...
              (this._dirtyRowService.markDirty(e.y),
                ...
                e.y === e.scrollBottom + 1
                  ? (e.y--, this._terminal.scroll(this._eraseAttrData()))
                  : e.y >= this._bufferService.rows && (e.y = this._bufferService.rows - 1),
            ...
            (t.prototype.backspace = function () {
              (this._restrictCursor(),
                this._bufferService.buffer.x > 0 && this._bufferService.buffer.x--);
            }),
              ...
              if (!(this._bufferService.buffer.x >= this._bufferService.cols)) {
                ...
                ((this._bufferService.buffer.x = this._bufferService.buffer.nextStop()),
                  this._optionsService.options.screenReaderMode &&
                    this._terminal.onA11yTabEmitter.fire(this._bufferService.buffer.x - e));
              }
            }),
              ...
              (this._dirtyRowService.markDirty(this._bufferService.buffer.y),
                this._coreService.decPrivateModes.origin
                  ? ((this._bufferService.buffer.x = e),
                    (this._bufferService.buffer.y = this._bufferService.buffer.scrollTop + t))
                  : ((this._bufferService.buffer.x = e), (this._bufferService.buffer.y = t)),
                this._restrictCursor(),
                this._dirtyRowService.markDirty(this._bufferService.buffer.y));
            }),
            ...
            (t.prototype._resetBufferLine = function (e) {
              ...
              (t.fill(this._bufferService.buffer.getNullCell(this._eraseAttrData())),
                (t.isWrapped = !1));
            }),
              ...
              switch ((this._restrictCursor(), e.params[0])) {
                ...
                case 1:
                  for (
                    t = this._bufferService.buffer.y,
                      this._dirtyRowService.markDirty(t),
                      this._eraseInBufferLine(t, 0, this._bufferService.buffer.x + 1, !0),
                      this._bufferService.buffer.x + 1 >= this._bufferService.cols &&
                        (this._bufferService.buffer.lines.get(t + 1).isWrapped = !1);
                    t--;
                  )
                    this._resetBufferLine(t);
            ...
            (t.prototype.insertLines = function (e) {
              ...
              if (!(r.y > r.scrollBottom || r.y < r.scrollTop)) {
                for (
                  var i = r.y + r.ybase,
                    n = this._bufferService.rows - 1 - r.scrollBottom,
                    o = this._bufferService.rows - 1 + r.ybase - n + 1;
                  t--;
                )
                  (r.lines.splice(o - 1, 1),
                    r.lines.splice(i, 0, r.getBlankLine(this._eraseAttrData())));
            ...
            (t.prototype.insertChars = function (e) {
              ...
              var t = this._bufferService.buffer.lines.get(
                this._bufferService.buffer.y + this._bufferService.buffer.ybase,
              );
              t &&
                (t.insertCells(
                  this._bufferService.buffer.x,
            ...
            (t.prototype.scrollDown = function (e) {
              for (var t = e.params[0] || 1, r = this._bufferService.buffer; t--; )
                (r.lines.splice(r.ybase + r.scrollBottom, 1),
                  r.lines.splice(r.ybase + r.scrollTop, 0, r.getBlankLine(u.DEFAULT_ATTR_DATA)));
              this._dirtyRowService.markRangeDirty(r.scrollTop, r.scrollBottom);
            }),
            (t.prototype.scrollLeft = function (e) {
              ...
              if (!(t.y > t.scrollBottom || t.y < t.scrollTop)) {
                for (var r = e.params[0] || 1, i = t.scrollTop; i <= t.scrollBottom; ++i) {
                  ...
                  (n.deleteCells(0, r, t.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                    (n.isWrapped = !1));
                }
            ...
            (t.prototype.scrollRight = function (e) {
              ...
              if (!(t.y > t.scrollBottom || t.y < t.scrollTop)) {
                for (var r = e.params[0] || 1, i = t.scrollTop; i <= t.scrollBottom; ++i) {
                  var n = t.lines.get(t.ybase + i);
                  (n.insertCells(0, r, t.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                    (n.isWrapped = !1));
                }
                this._dirtyRowService.markRangeDirty(t.scrollTop, t.scrollBottom);
              }
            ...
            (t.prototype.sendDeviceAttributesPrimary = function (e) {
              e.params[0] > 0 ||
                ...
                this._terminal.is('screen')
                  ? this._coreService.triggerDataEvent(o.C0.ESC + '[?1;2c')
                  : this._terminal.is('linux') &&
                    this._coreService.triggerDataEvent(o.C0.ESC + '[?6c'));
            }),
            (t.prototype.sendDeviceAttributesSecondary = function (e) {
              e.params[0] > 0 ||
                (this._terminal.is('xterm')
                  ? this._coreService.triggerDataEvent(o.C0.ESC + '[>0;276;0c')
                  : this._terminal.is('rxvt-unicode')
                    ? this._coreService.triggerDataEvent(o.C0.ESC + '[>85;95;0c')
                    : this._terminal.is('linux')
                      ? this._coreService.triggerDataEvent(e.params[0] + 'c')
                      : this._terminal.is('screen') &&
                        this._coreService.triggerDataEvent(o.C0.ESC + '[>83;40003;0c'));
            }),
              ...
              for (var t, r, i = 0; i < e.length; i++)
                switch (e.params[i]) {
                  ...
                  case 2:
                    ...
                    break;
                  case 3:
                    this._optionsService.options.windowOptions.setWinLines &&
                  ...
                  case 66:
                    (this._logService.debug('Serial port requested application keypad.'),
                      ...
                      null === (t = this._terminal.viewport) || void 0 === t || t.syncScrollArea());
                    break;
                  case 9:
                  ...
                  case 1047:
                    (this._bufferService.buffers.activateAltBuffer(this._eraseAttrData()),
                      ...
                      null === (r = this._terminal.viewport) || void 0 === r || r.syncScrollArea(),
                ...
                switch (e.params[i]) {
                  ...
                  case 1047:
                    (this._bufferService.buffers.activateNormalBuffer(),
                      1049 === e.params[i] && this.restoreCursor(),
                      this._onRequestRefreshRows.fire(0, this._bufferService.rows - 1),
                      null === (r = this._terminal.viewport) || void 0 === r || r.syncScrollArea(),
                      this._terminal.showCursor());
                    break;
              ...
              return (
                38 === i[0]
                  ? 2 === i[1]
                    ? ((r.fg |= 50331648),
                      (r.fg &= -16777216),
                      (r.fg |= p.AttributeData.fromColorRGB([i[3], i[4], i[5]])))
                    : 5 === i[1] && ((r.fg &= -50331904), (r.fg |= 33554432 | (255 & i[3])))
                  : 48 === i[0] &&
                    (2 === i[1]
                      ? ((r.bg |= 50331648),
                        (r.bg &= -16777216),
                        (r.bg |= p.AttributeData.fromColorRGB([i[3], i[4], i[5]])))
                      : 5 === i[1] && ((r.bg &= -50331904), (r.bg |= 33554432 | (255 & i[3])))),
                o
              );
            }),
            (t.prototype.charAttributes = function (e) {
              if (1 === e.length && 0 === e.params[0])
                return (
                  (this._curAttrData.fg = u.DEFAULT_ATTR_DATA.fg),
                  void (this._curAttrData.bg = u.DEFAULT_ATTR_DATA.bg)
                );
                  ...
                  : t >= 40 && t <= 47
                    ...
                    : t >= 90 && t <= 97
                      ...
                      : t >= 100 && t <= 107
                        ...
                        : 0 === t
                          ? ((i.fg = u.DEFAULT_ATTR_DATA.fg), (i.bg = u.DEFAULT_ATTR_DATA.bg))
                          : 1 === t
                            ? (i.fg |= 134217728)
                            : 3 === t
                              ? (i.bg |= 67108864)
                                              ...
                                              : 25 === t
                                                ...
                                                : 27 === t
                                                  ...
                                                  : 28 === t
                                                    ...
                                                    : 39 === t
                                                      ? ((i.fg &= -67108864),
                                                        (i.fg |= 16777215 & u.DEFAULT_ATTR_DATA.fg))
                                                      : 49 === t
                                                        ? ((i.bg &= -67108864),
                                                          (i.bg |=
                                                            16777215 & u.DEFAULT_ATTR_DATA.bg))
                                                        : 38 === t || 48 === t
                                                          ? (n += this._extractColor(e, n, i))
                                                          : 100 === t
                                                            ? ((i.fg &= -67108864),
                                                              (i.fg |=
                                                                16777215 & u.DEFAULT_ATTR_DATA.fg),
                                                              (i.bg &= -67108864),
                                                              (i.bg |=
                                                                16777215 & u.DEFAULT_ATTR_DATA.bg))
            ...
            (t.prototype.setScrollRegion = function (e) {
              var t,
                r = e.params[0] || 1;
              ((e.length < 2 || (t = e.params[1]) > this._bufferService.rows || 0 === t) &&
                (t = this._bufferService.rows),
                t > r &&
            ...
            (t.prototype.windowOptions = function (e) {
              if (m(e.params[0], this._optionsService.options.windowOptions)) {
                ...
                switch (e.params[0]) {
                  ...
                  case 16:
                    if (r) {
                      ((i = r.dimensions.scaledCellWidth.toFixed(0)),
                        (n = r.dimensions.scaledCellHeight.toFixed(0)));
            ...
            (t.prototype.saveCursor = function (e) {
              ((this._bufferService.buffer.savedX = this._bufferService.buffer.x),
                (this._bufferService.buffer.savedY =
                  this._bufferService.buffer.ybase + this._bufferService.buffer.y),
            ...
            (t.prototype.keypadApplicationMode = function () {
              ...
              (this._logService.debug('Serial port requested application keypad.'),
                (this._coreService.decPrivateModes.applicationKeypad = !0),
                null === (e = this._terminal.viewport) || void 0 === e || e.syncScrollArea());
            }),
            ...
            (t.prototype.selectCharset = function (e) {
              2 === e.length
                ? '/' !== e[0] &&
                  this._charsetService.setgCharset(b[e[0]], s.CHARSETS[e[1]] || s.DEFAULT_CHARSET)
            ...
            (t.prototype.reverseIndex = function () {
              ...
              if (e.y === e.scrollTop) {
                ...
                (e.lines.shiftElements(e.y + e.ybase, t, 1),
                  e.lines.set(e.y + e.ybase, e.getBlankLine(this._eraseAttrData())),
                  this._dirtyRowService.markRangeDirty(e.scrollTop, e.scrollBottom));
          ...
          (r.prototype.parse = function (e, t) {
            for (
              ...
              switch ((i = l[(n << 8) | ((r = e[h]) < 160 ? r : 160)]) >> 4) {
                ...
                case 7:
                  for (
                    var f = this._csiHandlers[(a << 8) | r], _ = f ? f.length - 1 : -1;
                    _ >= 0 && !1 === f[_](c);
                    _--
                  );
                ...
                case 10:
                  for (
                    var d = this._escHandlers[(a << 8) | r], p = d ? d.length - 1 : -1;
                    p >= 0 && !1 === d[p]();
                    p--
                  );
        ...
        y = (function (e) {
          function t(t, r, i, n, o, s, f, _) {
            ...
            ((d._colors = t),
              ...
              (d._linkifier = i),
              (d._bufferService = n),
              (d._charSizeService = o),
              (d._optionsService = s),
              (d.coreService = f),
              (d.coreBrowserService = _),
              (d._id = g++),
              (d._onRequestRefreshRows = new v.EventEmitter()));
            var p = d._optionsService.options.allowTransparency;
            return (
              (d._characterJoinerRegistry = new u.CharacterJoinerRegistry(d._bufferService)),
              (d._renderLayers = [
          ...
          return (
            ...
            (t = o(
              [
                s(3, d.IBufferService),
                s(4, _.ICharSizeService),
                s(5, d.IOptionsService),
                s(6, d.ICoreService),
                s(7, _.ICoreBrowserService),
              ],
              t,
            ))
          );
        ...
        u = (function (e) {
          ...
          return (
            ...
            (t.prototype.resize = function (t) {
              ...
              ((this._characterWidth === t.scaledCharWidth && this._characterFont === r) ||
                ...
                for (
                  ...
                  if (0 !== u.getWidth()) {
                    ...
                    (!f &&
                      ...
                      ((u.content &= -12582913), (u.content |= 2 << 22)),
                      i(u, h, n),
                      (h = _));
                  }
                }
                ...
                this._forEachCell(e, t, null, function (e, t, l) {
                  ...
                  (e.isInverse()
                    ? (h = e.isFgDefault()
                        ...
                        : e.isFgRGB()
                          ? 'rgb(' + a.AttributeData.toColorRGB(e.getFgColor()).join(',') + ')'
                          : r._colors.ansi[e.getFgColor()].css)
                    : e.isBgRGB()
                      ? (h = 'rgb(' + a.AttributeData.toColorRGB(e.getBgColor()).join(',') + ')')
                      : e.isBgPalette() && (h = r._colors.ansi[e.getBgColor()].css),
                    null === c && ((o = t), (s = l)),
                    l !== s
                      ? ((i.fillStyle = c || ''), r._fillCells(o, s, n - o, 1), (o = t), (s = l))
                      : c !== h &&
                        ((i.fillStyle = c || ''), r._fillCells(o, s, t - o, 1), (o = t), (s = l)),
                    (c = h));
                }),
                null !== c && ((i.fillStyle = c), this._fillCells(o, s, n - o, 1)),
                i.restore());
            }),
                ...
                if (!e.isInvisible() && (r._drawChars(e, t, i), e.isUnderline())) {
                  if ((r._ctx.save(), e.isInverse()))
                    if (e.isBgDefault()) r._ctx.fillStyle = r._colors.background.css;
                      ...
                      r._ctx.fillStyle =
                        'rgb(' + a.AttributeData.toColorRGB(e.getBgColor()).join(',') + ')';
                    else {
                      var n = e.getBgColor();
                      (r._optionsService.options.drawBoldTextInBrightColors &&
                        e.isBold() &&
                        n < 8 &&
                        (n += 8),
      ...
      var v = (function (e) {
        function t(t, r) {
          ...
          ((i._config = r),
            ...
            (i._cacheCtx = h.throwIfFalsy(i._cacheCanvas.getContext('2d', { alpha: !0 }))));
        ...
        return (
          ...
          (t.prototype.dispose = function () {
            null !== this._bitmapCommitTimeout &&
              (window.clearTimeout(this._bitmapCommitTimeout), (this._bitmapCommitTimeout = null));
          }),
          ...
          (t.prototype._drawToCache = function (e, t) {
            ...
            ((this._tmpCtx.font =
              ...
              this._tmpCtx.fillText(e.chars, 0, this._config.scaledCharHeight / 2),
    ...
    function (e, t, r) {
      ...
      var o = r(13),
        ...
        a = (function (e) {
          function t(t, r, i, n, o, a, c, l, h) {
            ...
            return (
              (u._onRequestRefreshRowsEvent = o),
              (u.bufferService = a),
              (u.optionsService = c),
              (u._coreService = l),
          ...
          return (
            ...
            (t.prototype.onOptionsChanged = function () {
              ...
              (this._optionsService.options.cursorBlink
                ? this._cursorBlinkStateManager ||
                  (this._cursorBlinkStateManager = new c(
            ...
            (t.prototype.onGridChanged = function (e, t) {
              !this._cursorBlinkStateManager || this._cursorBlinkStateManager.isPaused
                ? this._render(!1)
                : this._cursorBlinkStateManager.restartBlinkAnimation();
            }),
              ...
              if (this._coreService.isCursorInitialized && !this._coreService.isCursorHidden) {
                ...
                if (r < 0 || r >= this._bufferService.rows) this._clearCursor();
                  ...
                  (this._bufferService.buffer.lines
                    .get(t)
                    .loadCell(this._bufferService.buffer.x, this._cell),
                  ...
                  if (!this._coreBrowserService.isFocused) {
                    ...
                    return (
                      i && 'block' !== i
                        ? this._cursorRenderers[i](this._bufferService.buffer.x, r, this._cell)
                        : this._renderBlurCursor(this._bufferService.buffer.x, r, this._cell),
                      this._ctx.restore(),
                  ...
                  if (
                    ...
                    (this._ctx.save(),
                      this._cursorRenderers[this._optionsService.options.cursorStyle || 'block'](
                        this._bufferService.buffer.x,
                        r,
                        this._cell,
                      ),
            ...
            (t.prototype._renderBarCursor = function (e, t, r) {
              (this._ctx.save(),
                (this._ctx.fillStyle = this._colors.cursor.css),
                this._fillLeftLineAtCell(e, t, this._optionsService.options.cursorWidth),
                this._ctx.restore());
            }),
      ...
      var c = (function () {
        ...
        return (
          ...
          (e.prototype.dispose = function () {
            (this._blinkInterval &&
              (window.clearInterval(this._blinkInterval), (this._blinkInterval = void 0)),
              this._blinkStartTimeout &&
                (window.clearTimeout(this._blinkStartTimeout), (this._blinkStartTimeout = void 0)),
              this._animationFrame &&
        ...
        n = (function () {
          function e(e, t, r, n) {
            ((this._bufferService = e),
              ...
              (this._onLinkHover = new i.EventEmitter()),
              (this._onLinkLeave = new i.EventEmitter()),
              (this._onLinkTooltip = new i.EventEmitter()),
              (this._rowsToLinkify = { start: void 0, end: void 0 }));
          }
          return (
            Object.defineProperty(e.prototype, 'onLinkHover', {
              get: function () {
            ...
            (e.prototype.linkifyRows = function (t, r) {
              ...
              this._mouseZoneManager &&
                (void 0 === this._rowsToLinkify.start || void 0 === this._rowsToLinkify.end
                  ? ((this._rowsToLinkify.start = t), (this._rowsToLinkify.end = r))
                  : ((this._rowsToLinkify.start = Math.min(this._rowsToLinkify.start, t)),
            ...
            (e.prototype._linkifyRows = function () {
              ...
              if (void 0 !== this._rowsToLinkify.start && void 0 !== this._rowsToLinkify.end) {
                ...
                if (!(t >= e.lines.length)) {
                  for (
                    var r =
                        e.ydisp + Math.min(this._rowsToLinkify.end, this._bufferService.rows) + 1,
              ...
              for (
                var i,
                  ...
                  a = function () {
                    ...
                    if (!a)
                      return (
                        c._logService.debug('match found without corresponding matchIndex', i, r),
                        'break'
                      );
                    if (((s = t.indexOf(a, s + 1)), (o.lastIndex = s + a.length), s < 0))
                      return 'break';
                    ...
                    r.validationCallback
                      ? r.validationCallback(a, function (e) {
                          n._rowsTimeoutId ||
                            (e && n._addLink(l[1], l[0] - n._bufferService.buffer.ydisp, a, r, f));
                        })
                ...
                (0 === h && ((h = this._bufferService.cols), u--),
                  this._mouseZoneManager.add(
                    new o(
                      ...
                      function () {
                        (s._onLinkHover.fire(s._createLinkHoverEvent(c, l, h, u, n)),
                          s._element.classList.add('xterm-cursor-pointer'));
                      },
                      function (e) {
                        (s._onLinkTooltip.fire(s._createLinkHoverEvent(c, l, h, u, n)),
                      ...
                      function () {
                        (s._onLinkLeave.fire(s._createLinkHoverEvent(c, l, h, u, n)),
                          s._element.classList.remove('xterm-cursor-pointer'),
        ...
        p = (function () {
          function e(e, t, r, i, n, o, l, h) {
            ...
            ((this._scrollLines = e),
              ...
              (this._onLinuxMouseSelection = new c.EventEmitter()),
              (this._onRedrawRequest = new c.EventEmitter()),
              (this._onSelectionChange = new c.EventEmitter()),
          ...
          return (
            Object.defineProperty(e.prototype, 'onLinuxMouseSelection', {
              get: function () {
            ...
            Object.defineProperty(e.prototype, 'selectionText', {
              get: function () {
                ...
                if (3 === this._activeSelectionMode) {
                  ...
                  if (e[1] !== t[1]) {
                    ((c = r.lines.get(t[1])),
                      (s = r.translateBufferLineToString(t[1], !0, 0, t[0])));
                    c && c.isWrapped ? (i[i.length - 1] += s) : i.push(s);
                  }
                }
                return i
            ...
            (e.prototype._areCoordsInSelection = function (e, t, r) {
              return (
                (e[1] > t[1] && e[1] < r[1]) ||
                (t[1] === r[1] && e[1] === t[1] && e[0] >= t[0] && e[0] < r[0]) ||
            ...
            (e.prototype.selectWordAtCursor = function (e) {
              var t = this._getMouseBufferCoords(e);
              t &&
                (this._selectWordAt(t, !1), (this._model.selectionEnd = void 0), this.refresh(!0));
            }),
            (e.prototype.selectAll = function () {
            ...
            (e.prototype._getMouseEventScrollAmount = function (e) {
              var t = u.getCoordsRelativeToElement(e, this._screenElement)[1],
                r =
                  this._bufferService.rows *
                  Math.ceil(this._charSizeService.height * this._optionsService.options.lineHeight);
              return t >= 0 && t <= r
                ? 0
                : (t > r && (t -= r),
            ...
            (e.prototype.shouldForceSelection = function (e) {
              return o.isMac
                ? e.altKey && this._optionsService.options.macOptionClickForcesSelection
                : e.shiftKey;
            }),
            ...
            (e.prototype.shouldColumnSelect = function (e) {
              return (
                e.altKey && !(o.isMac && this._optionsService.options.macOptionClickForcesSelection)
              );
            }),
                ...
                if (o) {
                  ...
                  if (' ' === s.charAt(a)) {
                    ...
                    for (
                      ...
                      d > 0 &&
                      a > 0 &&
                      !this._isCharWordSeparator(o.loadCell(d - 1, this._workCell));
                    ) {
                    ...
                    for (
                      ...
                      p < o.length &&
                      c + 1 < s.length &&
                      !this._isCharWordSeparator(o.loadCell(p + 1, this._workCell));
                    ) {
            ...
            (e.prototype._isCharWordSeparator = function (e) {
              return (
                0 !== e.getWidth() &&
                this._optionsService.options.wordSeparator.indexOf(e.getChars()) >= 0
              );
            }),
            (e.prototype._selectLineAt = function (e) {
              ...
              ((this._model.selectionStart = [0, t.first]),
                (this._model.selectionEnd = [this._bufferService.cols, t.last]),
                (this._model.selectionStartLength = 0));
            }),
            (e = i(
              [
                n(3, l.ICharSizeService),
                n(4, h.IBufferService),
                n(5, h.ICoreService),
                n(6, l.IMouseService),
                n(7, h.IOptionsService),
              ],
              e,
            ))
          );
    ...
    function (e, t, r) {
      ...
      function c(e, t, r, i, n, o) {
        for (var s = e, a = t, c = ''; s !== r || a !== i; )
          ((s += n ? 1 : -1),
            n && s > o.cols - 1
              ? ((c += o.buffer.translateBufferLineToString(a, !1, e, s)), (s = 0), (e = 0), a++)
              : !n &&
                s < 0 &&
              ...
              if (t) {
                ...
                t.decodeAudioData(
                  this._base64ToArrayBuffer(
                    this._removeMimeType(this._optionsService.options.bellSound),
                  ),
                  function (e) {
        ...
        u = (function (e) {
          function t(t, r, i, n, o) {
            ...
            return (
              ...
              (s._bufferService = i),
              (s._mouseService = n),
              (s._selectionService = o),
              (s._zones = []),
              (s._areZonesActive = !1),
              (s._lastHoverCoords = [void 0, void 0]),
              (s._initialSelectionLength = 0),
              s.register(
                c.addDisposableDomListener(s._element, 'mousedown', function (e) {
          ...
          return (
              ...
              if (0 !== this._zones.length) {
                ...
                for (var r = 0; r < this._zones.length; r++) {
                  ...
                  ((i.y1 > e && i.y1 <= t + 1) ||
                    ...
                    (this._currentZone &&
                      this._currentZone === i &&
                      (this._currentZone.leaveCallback(), (this._currentZone = void 0)),
            ...
            (t.prototype._onMouseMove = function (e) {
              (this._lastHoverCoords[0] === e.pageX && this._lastHoverCoords[1] === e.pageY) ||
                (this._onHover(e), (this._lastHoverCoords = [e.pageX, e.pageY]));
            }),
            ...
            (t.prototype._onMouseDown = function (e) {
              ...
              ((this._initialSelectionLength = this._getSelectionLength()), this._areZonesActive) &&
                (null === (t = this._findZoneEventAt(e)) || void 0 === t
                  ? void 0
            ...
            (t.prototype._onClick = function (e) {
              ...
              t &&
                ...
                (t.clickCallback(e), e.preventDefault(), e.stopImmediatePropagation());
            }),
        ...
        u = (function (e) {
          function t(t, r) {
            ...
            return (
              ...
              i._terminal.element.insertAdjacentElement('afterbegin', i._accessibilityTreeRoot),
          ...
          return (
            ...
            (t.prototype._onBoundaryFocus = function (e, t) {
              ...
              if (
                ...
                if (
                  (0 === t
                    ? ((n = r), (o = this._rowElements.pop()), this._rowContainer.removeChild(o))
                    : ((n = this._rowElements.shift()), (o = r), this._rowContainer.removeChild(n)),
            ...
            (t.prototype._renderRows = function (e, t) {
              for (
                var r = this._terminal.buffer, i = r.lines.length.toString(), n = e;
                n <= t;
                n++
              ) {
                ...
                a &&
                  (0 === o.length ? (a.innerHTML = '&nbsp;') : (a.textContent = o),
        ...
        y = (function (e) {
          function t(t, r, i, n, o, s, c, l) {
            ...
            return (
              ...
              (h._element = r),
              (h._screenElement = i),
              (h._viewportElement = n),
              (h._linkifier = o),
              (h._charSizeService = s),
              (h._optionsService = c),
              (h._bufferService = l),
              (h._terminalClass = g++),
              (h._rowElements = []),
              (h._onRequestRefreshRows = new f.EventEmitter()),
              (h._rowContainer = document.createElement('div')),
              h._rowContainer.classList.add(p),
              (h._rowContainer.style.lineHeight = 'normal'),
              h._rowContainer.setAttribute('aria-hidden', 'true'),
              h._refreshRowElements(h._bufferService.cols, h._bufferService.rows),
              (h._selectionContainer = document.createElement('div')),
              h._selectionContainer.classList.add(v),
              ...
              h._updateDimensions(),
              h._injectCss(),
              (h._rowFactory = new a.DomRendererRowFactory(document, h._optionsService, h._colors)),
              h._element.classList.add(d + h._terminalClass),
              h._screenElement.appendChild(h._rowContainer),
              h._screenElement.appendChild(h._selectionContainer),
              h._linkifier.onLinkHover(function (e) {
          ...
          return (
            ...
            (t.prototype.dispose = function () {
              (this._element.classList.remove(d + this._terminalClass),
            ...
            (t.prototype._updateDimensions = function () {
              ...
              ((this.dimensions.scaledCharWidth =
                ...
                (this.dimensions.scaledCanvasHeight =
                  this.dimensions.scaledCellHeight * this._bufferService.rows),
                (this.dimensions.canvasWidth = Math.round(
                  this.dimensions.scaledCanvasWidth / window.devicePixelRatio,
                )),
                (this.dimensions.canvasHeight = Math.round(
                ...
                this._rowElements.forEach(function (t) {
                  ((t.style.width = e.dimensions.canvasWidth + 'px'),
                    (t.style.height = e.dimensions.actualCellHeight + 'px'),
                    (t.style.lineHeight = e.dimensions.actualCellHeight + 'px'),
            ...
            (t.prototype._injectCss = function () {
              ...
              ((t +=
                ...
                (t +=
                  ...
                  this._colors.foreground.css +
                  '; }'),
                (this._themeStyleElement.innerHTML = t));
            }),
            (t.prototype.onDevicePixelRatioChange = function () {
              this._updateDimensions();
            }),
              ...
              if (e && t) {
                ...
                if (!(o >= this._bufferService.rows || s < 0)) {
                  ...
                  if (r) a.appendChild(this._createSelectionElement(o, e[0], t[0], s - o + 1));
                    ...
                    if (
                      (a.appendChild(
                        this._createSelectionElement(o + 1, 0, this._bufferService.cols, h),
                      ),
                      o !== s)
                    ) {
            ...
            (t.prototype._createSelectionElement = function (e, t, r, i) {
              ...
              return (
                (n.style.height = i * this.dimensions.actualCellHeight + 'px'),
            ...
            (t.prototype.renderRows = function (e, t) {
              for (
                var r = this._bufferService.buffer.ybase + this._bufferService.buffer.y,
                  i = this._bufferService.buffer.x,
      ...
      var a = (function () {
        ...
        return (
          ...
          (e.prototype.createRow = function (e, r, o, a, l, h, u) {
            for (
              var f = this._document.createDocumentFragment(), _ = 0, d = Math.min(e.length, u) - 1;
              d >= 0;
              d--
            )
            ...
            for (d = 0; d < _; d++) {
              ...
              if (0 !== p) {
                ...
                if ((p > 1 && (v.style.width = h * p + 'px'), r && d === a))
                  switch (
                    (v.classList.add(t.CURSOR_CLASS), l && v.classList.add(t.CURSOR_BLINK_CLASS), o)
                  ) {
                    case 'bar':
                ...
                (this._workCell.isBold() && v.classList.add(t.BOLD_CLASS),
                  this._workCell.isItalic() && v.classList.add(t.ITALIC_CLASS),
                  this._workCell.isDim() && v.classList.add(t.DIM_CLASS),
                  this._workCell.isUnderline() && v.classList.add(t.UNDERLINE_CLASS),
                  this._workCell.isInvisible()
                    ? (v.textContent = n.WHITESPACE_CELL_CHAR)
                    : (v.textContent = this._workCell.getChars() || n.WHITESPACE_CELL_CHAR));
                ...
                switch (y) {
                  ...
                  case 50331648:
                    ...
                    this._applyMinimumContrast(v, this._colors.background, E) ||
                      this._addStyle(v, 'color:#' + c(g.toString(16), '0', 6));
                    break;
                  case 0:
                  default:
                    this._applyMinimumContrast(
                      ...
                      (S && v.classList.add('xterm-fg-' + i.INVERTED_DEFAULT_COLOR));
                }
                switch (m) {
                  case 16777216:
                  case 33554432:
          ...
          case 37:
            ...
            a
              ? ((s.key = i.C0.ESC + '[1;' + (a + 1) + 'D'),
                s.key === i.C0.ESC + '[1;3D' && (s.key = i.C0.ESC + (r ? 'b' : '[1;5D')))
              : (s.key = t ? i.C0.ESC + 'OD' : i.C0.ESC + '[D');
            break;
          case 39:
            if (e.metaKey) break;
            a
              ? ((s.key = i.C0.ESC + '[1;' + (a + 1) + 'C'),
                s.key === i.C0.ESC + '[1;3C' && (s.key = i.C0.ESC + (r ? 'f' : '[1;5C')))
              : (s.key = t ? i.C0.ESC + 'OC' : i.C0.ESC + '[C');
            break;
          case 38:
            if (e.metaKey) break;
            a
              ? ((s.key = i.C0.ESC + '[1;' + (a + 1) + 'A'),
                r || s.key !== i.C0.ESC + '[1;3A' || (s.key = i.C0.ESC + '[1;5A'))
              : (s.key = t ? i.C0.ESC + 'OA' : i.C0.ESC + '[A');
            break;
          case 40:
            if (e.metaKey) break;
            a
              ? ((s.key = i.C0.ESC + '[1;' + (a + 1) + 'B'),
                r || s.key !== i.C0.ESC + '[1;3B' || (s.key = i.C0.ESC + '[1;5B'))
              : (s.key = t ? i.C0.ESC + 'OB' : i.C0.ESC + '[B');
            break;
          case 45:
    ...
    function (e, t, r) {
      ...
      t.updateWindowsModeWrappedState = function (e) {
        var t,
          r =
            null === (t = e.buffer.lines.get(e.buffer.ybase + e.buffer.y - 1)) || void 0 === t
              ? void 0
              : t.get(e.cols - 1),
        ...
        d = (function (e) {
          function t(t, r, i, n, o) {
            ...
            if (
              ...
              (s.charSizeService = o),
              (s._isPaused = !1),
              (s._needsFullRefresh = !1),
              (s._canvasWidth = 0),
              (s._canvasHeight = 0),
              (s._onDimensionsChange = new c.EventEmitter()),
              (s._onRender = new c.EventEmitter()),
              (s._onRefreshRequest = new c.EventEmitter()),
              (s._renderDebouncer = new a.RenderDebouncer(function (e, t) {
                return s._renderRows(e, t);
              })),
              s.register(s._renderDebouncer),
              (s._screenDprMonitor = new h.ScreenDprMonitor()),
              s._screenDprMonitor.setListener(function () {
                return s.onDevicePixelRatioChange();
              }),
              s.register(s._screenDprMonitor),
              s.register(
          ...
          return (
            ...
            (t.prototype._onIntersectionChange = function (e) {
              ((this._isPaused = 0 === e.intersectionRatio),
                !this._isPaused &&
                  ...
                  (this.refreshRows(0, this._rowCount - 1), (this._needsFullRefresh = !1)));
            }),
            ...
            (t.prototype._renderRows = function (e, t) {
              (this._renderer.renderRows(e, t), this._onRender.fire({ start: e, end: t }));
            }),
            (t.prototype.resize = function (e, t) {
            ...
            (t.prototype._fireOnCanvasResize = function () {
              (this._renderer.dimensions.canvasWidth === this._canvasWidth &&
                this._renderer.dimensions.canvasHeight === this._canvasHeight) ||
            ...
            (t.prototype.setRenderer = function (e) {
              ...
              (this._renderer.dispose(),
                (this._renderer = e),
                this._renderer.onRequestRefreshRows(function (e) {
          ...
          return (
            ...
            (e.prototype.setOption = function (e, r) {
              ...
              this.options[e] !== r &&
                ...
                this.options[e] !== r && ((this.options[e] = r), this._onOptionChange.fire(e)));
            }),
        ...
        return (
          (e.prototype.measure = function () {
            ...
            return (
              0 !== e.width &&
                0 !== e.height &&
                ((this._result.width = e.width), (this._result.height = Math.ceil(e.height))),
              this._result
            );
          }),
          e
    ...
    function (e, t, r) {
      ...
      var a = (function () {
        function e(e) {
          ((this._optionsService = e),
            (this.cols = Math.max(e.options.cols, t.MINIMUM_COLS)),
            (this.rows = Math.max(e.options.rows, t.MINIMUM_ROWS)),
            (this.buffers = new s.BufferSet(e, this)));
        }
        return (
          Object.defineProperty(e.prototype, 'buffer', {
            get: function () {
    ...
    function (e, t, r) {
      ...
      var i = r(65),
        ...
        o = (function () {
          function e(e, t) {
            ((this.optionsService = e),
              (this.bufferService = t),
              (this._onBufferActivate = new n.EventEmitter()),
              (this._normal = new i.Buffer(!0, e, t)),
              this._normal.fillViewportRows(),
              (this._alt = new i.Buffer(!1, e, t)),
              (this._activeBuffer = this._normal),
              this.setupTabStops());
          }
          return (
            Object.defineProperty(e.prototype, 'onBufferActivate', {
              get: function () {
      ...
      var h = (function () {
        function e(e, t, r) {
          ((this._hasScrollback = e),
            ...
            (this.lines = new i.CircularList(this._getCorrectBufferLength(this._rows))),
            (this.scrollTop = 0),
        ...
        return (
          ...
          (e.prototype.getWhitespaceCell = function (e) {
            return (
              e
                ? ((this._whitespaceCell.fg = e.fg), (this._whitespaceCell.bg = e.bg))
                : ((this._whitespaceCell.fg = 0), (this._whitespaceCell.bg = 0)),
                ...
                for (var a = this._rows; a < t; a++)
                  this.lines.length < t + this.ybase &&
                    (this._optionsService.options.windowsMode
                      ...
                      : this.ybase > 0 && this.lines.length <= this.ybase + this.y + s + 1
          ...
          (e.prototype._reflowLargerAdjustViewport = function (e, t, r) {
            for (var i = this.getNullCell(n.DEFAULT_ATTR_DATA), o = r; o-- > 0; )
              0 === this.ybase
                ? (this.y > 0 && this.y--,
                  this.lines.length < t && this.lines.push(new n.BufferLine(e, i)))
                ...
                if (!(h >= s && h < s + l.length)) {
                  ...
                  d =
                    0 === this.ybase && this.y !== this.lines.length - 1
                      ? Math.max(0, this.y - this.lines.maxLength + _)
                      : Math.max(0, this.lines.length - this.lines.maxLength + _);
                  for (var p = [], v = 0; v < _; v++) {
                    var g = this.getBlankLine(n.DEFAULT_ATTR_DATA, !0);
                    p.push(g);
                  }
                  (p.length > 0 &&
                    (i.push({ start: s + l.length + o, newLines: p }), (o += p.length)),
                    l.push.apply(l, p));
                  var y = f.length - 1,
                    b = f[y];
                  0 === b && (b = f[--y]);
                  for (var m = l.length - _ - 1, S = u; m >= 0; ) {
                    var C = Math.min(S, b);
                    if (
                      (l[y].copyCellsFrom(l[m], S - C, b - C, C, !0),
                      0 === (b -= C) && (b = f[--y]),
                      0 === (S -= C))
                    ) {
                      m--;
                  ...
                  for (var E = _ - d; E-- > 0; )
                    0 === this.ybase
                      ? this.y < t - 1
                        ...
                        : (this.ybase++, this.ydisp++)
                      : this.ybase < Math.min(this.lines.maxLength, this.lines.length + o) - t &&
            ...
            if (i.length > 0) {
              ...
              for (v = Math.min(this.lines.maxLength - 1, R + o - 1); v >= 0; v--)
                if (D && D.start > x + T) {
                  ...
                  (v++,
                    L.push({ index: x + 1, amount: D.newLines.length }),
                    (T += D.newLines.length),
                    (D = i[++k]));
              ...
              if (n >= a && n < c) a += h.length - 1;
                ...
                for (var u = 0, f = i(h, u, t), _ = 1, d = 0; _ < h.length; ) {
                  ...
                  (h[u].copyCellsFrom(h[_], d, f, y, !1),
                    ...
                    0 === f &&
                      0 !== u &&
                      2 === h[u - 1].getWidth(r - 1) &&
                      (h[u].copyCellsFrom(h[u - 1], r - 1, f++, 1, !1),
                      h[u - 1].setCell(r - 1, o)));
                }
                h[u].replaceCells(f, r, o);
                for (
                  var b = 0, m = h.length - 1;
                  m > 0 && (m > u || 0 === h[m].getTrimmedLength());
                  m--
                )
                  b++;
          ...
          return (
            ...
            (e.prototype.triggerBinaryEvent = function (e) {
              this._optionsService.options.disableStdin ||
                (this._logService.debug('sending binary "' + e + '"', function () {
                  return e.split('').map(function (e) {
                    return e.charCodeAt(0);
                  });
                }),
    ...
    function (e, t, r) {
      ...
      var c = { debug: s.DEBUG, info: s.INFO, warn: s.WARN, error: s.ERROR, off: s.OFF },
        l = (function () {
          function e(e) {
            var t = this;
            ((this._optionsService = e),
      ...
      var a = (function () {
        ...
        return (
          ...
          (e.prototype.createInstance = function (e) {
            for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
            for (
              var n = o.getServiceDependencies(e).sort(function (e, t) {
              ...
              if (!h)
                throw new Error(
                  '[createInstance] ' + e.name + ' depends on UNKNOWN service ' + l.id + '.',
                );
              s.push(h);
            }
